 ...
 */
#define STRUCT_VIRTUAL_SLAB_SIZE (32 * sizeof(void *))
#define SLAB_VPAGES ((SLAB_END_ADDR - SLAB_BASE_ADDR) / PAGE_SIZE)
#define SLAB_META_SIZE ALIGN(SLAB_VPAGES * STRUCT_VIRTUAL_SLAB_SIZE, PAGE_SIZE)
#define SLAB_DATA_BASE_ADDR (SLAB_BASE_ADDR + SLAB_META_SIZE)

#define is_slab_virtual_addr(ptr) ((unsigned long)(ptr) >= SLAB_DATA_BASE_ADDR && \
	(unsigned long)(ptr) < SLAB_END_ADDR)
#define is_slab_virtual_meta(ptr) ((unsigned long)(ptr) >= SLAB_BASE_ADDR && \
